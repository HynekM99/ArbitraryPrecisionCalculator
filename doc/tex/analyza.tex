...
\begin{tabular}{l|ccc|ccc}
    ...
    \multirow{5}{*}{Povolení předchůdci}   & \multicolumn{3}{c|}{\multirow{5}{*}{\begin{tabular}[c]{@{}c@{}}Číslo\\ )\end{tabular}}} & \multicolumn{3}{c}{\multirow{5}{*}{\begin{tabular}[c]{@{}c@{}}Unární, pravá\\ Binární\\ Číslo\\ (\\ Bez předchůdce\end{tabular}}} \\
